...
const Cart = () => {
  ...
  return (
    <div className="w-8/12  text-center  lg:px-48 py-10 m-auto ">
      ...
      {cartItem?.restaurant != null ? (
        <div className="shadow-2xl m-2 p-2 rounded-xl border shadow-orange-500 sm:w-screen">
            ...
            <div className="flex items-center mt-6 justify-between ml-6">
              <div>
                <span className=" flex items-center ">
                  ...
                  <p className="ml-1 text-sm flex flex-wrap">{item[0]?.name}</p>
                </span>
              </div>
        ...
        <div className="text-center px-32 m-auto">
          <div>
